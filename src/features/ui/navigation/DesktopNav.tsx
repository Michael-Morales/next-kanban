...
export function DesktopNav({ isOpen, onClose }: IProps) {
  return (
    <div
      className={`fixed z-20 hidden h-[calc(100%-64px)] w-72 overflow-y-auto border-t border-secondary bg-white p-8 transition dark:border-theme-light-dark dark:bg-theme-dark md:flex md:flex-col md:justify-between ${
