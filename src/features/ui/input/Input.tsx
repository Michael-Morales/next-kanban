...
export function Input({ label, type = "text", placeholder, register }: IProps) {
  return (
    <label className="flex flex-col gap-y-2">
      ...
      {type === "textarea" ? (
        <textarea
          className="h-28 resize-none rounded border-light bg-transparent py-2 px-4 text-sm text-black transition-colors placeholder:text-placeholder hover:border-primary focus:border-primary focus:ring-0 focus:ring-offset-0"
